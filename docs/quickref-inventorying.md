...
| **Reorder** | Stock List items at or below their threshold — download a CSV, or use Copy list / E-mail this list to place the order. |
| **Usage** | The permanent, all-time consumption record by month/year — CSV download. |

## Running a physical audit (e.g. monthly shelf inventory)
...
2. **Weigh every spool** — a normal weigh during the audit window marks that
   spool "found" automatically, no extra step. **Leave the Inventory page
   open** while you work — the found count updates itself live as each spool
   is weighed.
3. When every spool has been checked, click **Finish audit**. The page now
   ...
   - **Found** — it's physically there but wasn't weighed (eyeballed it
